...
//using object destructuring in Java Script
function TopicsCard1({topic, title, slno}) {
  return (
    <div className="card w-25 m-4 d-inline-block">
      ...
      <div className="card-body">
        <h5 className="card-title text-success fw-bold">{slno}. {title}</h5>
